...
import org.springframework.web.bind.a nnotation.*;
...
public class UserAddressApi {
    ...
    public ResponseEntity<?> save(@Valid @RequestBody UserAdressRequest userAdressRequest,
    ...
    public ResponseEntity<?> update(@Valid @RequestBody  UserAdressRequest userAdressRequest, BindingResult bindingResult){
        if(bindingResult.hasErrors()){
            return new ResponseEntity<>(bin dingResult.getAllErrors(), HttpStatus.BAD_REQUEST);
        }
